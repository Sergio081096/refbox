...
public:
    ...
    std::shared_ptr<google::protobuf::Message> beacon2main();
    void sendTasktoRobot(AgentTask agent_task);


private:
    std::shared_ptr<google::protobuf::Message> beacon2main_msg;
    std::string m_host;
    int m_priv_recv_port;
    int m_pub_recv_port;
    unsigned long int m_sequence_nr_;
    MessageRegister *m_mr;
    std::shared_ptr<ProtobufStreamServer> m_private_peer_robot;
    bool m_is_cyan;
...
public:
    ...
    void sendBeaconSignal(Robot &robot);
