...
class Parameters {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('useRealRobot')) {
        this.useRealRobot = initObj.useRealRobot
      }
      else {
        this.useRealRobot = false;
      }
      if (initObj.hasOwnProperty('useLidar')) {
        this.useLidar = initObj.useLidar
      }
      else {
        this.useLidar = false;
      }
      if (initObj.hasOwnProperty('useSArray')) {
        this.useSArray = initObj.useSArray
      }
      else {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [useRealRobot]
    bufferOffset = _serializer.bool(obj.useRealRobot, buffer, bufferOffset);
    // Serialize message field [useLidar]
    bufferOffset = _serializer.bool(obj.useLidar, buffer, bufferOffset);
    // Serialize message field [useSArray]
    bufferOffset = _serializer.bool(obj.useSArray, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [useRealRobot]
    data.useRealRobot = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [useLidar]
    data.useLidar = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [useSArray]
    data.useSArray = _deserializer.bool(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.useRealRobot !== undefined) {
      resolved.useRealRobot = msg.useRealRobot;
    }
    else {
      resolved.useRealRobot = false
    }

    if (msg.useLidar !== undefined) {
      resolved.useLidar = msg.useLidar;
    }
    else {
      resolved.useLidar = false
    }

    if (msg.useSArray !== undefined) {
      resolved.useSArray = msg.useSArray;
    }
    else {
      resolved.useSArray = false
    }
