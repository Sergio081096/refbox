...
class simulator_action_plannerRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type simulator_action_plannerRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type simulator_action_plannerRequest
    let len;
    let data = new simulator_action_plannerRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new simulator_action_plannerRequest(null);
...
class simulator_action_plannerResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.answer = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type simulator_action_plannerResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type simulator_action_plannerResponse
    let len;
    let data = new simulator_action_plannerResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'simulator/simulator_action_plannerResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new simulator_action_plannerResponse(null);
...
module.exports = {
  Request: simulator_action_plannerRequest,
  Response: simulator_action_plannerResponse,
  md5sum() { return '5d4b465f13d9abdf0754aeb1704ce89b'; },
  datatype() { return 'simulator/simulator_action_planner'; }
};
