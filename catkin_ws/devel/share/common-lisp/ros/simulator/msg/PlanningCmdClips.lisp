...
(cl:defmethod cl:initialize-instance :after ((m <PlanningCmdClips>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PlanningCmdClips)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name simulator-msg:<PlanningCmdClips> is deprecated: use simulator-msg:PlanningCmdClips instead.")))
...
(cl:defmethod successful-val ((m <PlanningCmdClips>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulator-msg:successful-val is deprecated.  Use simulator-msg:successful instead.")
  (successful m))
