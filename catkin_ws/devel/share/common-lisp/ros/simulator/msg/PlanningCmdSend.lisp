...
(cl:defmethod cl:initialize-instance :after ((m <PlanningCmdSend>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PlanningCmdSend)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name simulator-msg:<PlanningCmdSend> is deprecated: use simulator-msg:PlanningCmdSend instead.")))
