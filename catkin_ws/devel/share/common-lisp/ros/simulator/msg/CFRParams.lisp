...
(cl:defmethod cl:initialize-instance :after ((m <CFRParams>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CFRParams)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name simulator-msg:<CFRParams> is deprecated: use simulator-msg:CFRParams instead.")))

(cl:ensure-generic-function 'frame_id-val :lambda-list '(m))
(cl:defmethod frame_id-val ((m <CFRParams>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulator-msg:frame_id-val is deprecated.  Use simulator-msg:frame_id instead.")
  (frame_id m))

(cl:ensure-generic-function 'frame_value-val :lambda-list '(m))
(cl:defmethod frame_value-val ((m <CFRParams>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulator-msg:frame_value-val is deprecated.  Use simulator-msg:frame_value instead.")
  (frame_value m))
