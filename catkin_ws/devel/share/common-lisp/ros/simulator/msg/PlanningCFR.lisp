...
(cl:defclass <PlanningCFR> (roslisp-msg-protocol:ros-message)
  ((command
   ...
   (params
    :reader params
    :initarg :params
    :type (cl:vector simulator-msg:CFRParams)
   :initform (cl:make-array 0 :element-type 'simulator-msg:CFRParams :initial-element (cl:make-instance 'simulator-msg:CFRParams))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <PlanningCFR>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PlanningCFR)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name simulator-msg:<PlanningCFR> is deprecated: use simulator-msg:PlanningCFR instead.")))
...
(cl:defmethod params-val ((m <PlanningCFR>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulator-msg:params-val is deprecated.  Use simulator-msg:params instead.")
  (params m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <PlanningCFR>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'params)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'simulator-msg:CFRParams))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<PlanningCFR>)))
  ...
  (cl:format cl:nil "string command~%CFRParams[] params~%~%================================================================================~%MSG: simulator/CFRParams~%string frame_id~%string frame_value~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'PlanningCFR)))
  "Returns full string definition for message of type 'PlanningCFR"
  (cl:format cl:nil "string command~%CFRParams[] params~%~%================================================================================~%MSG: simulator/CFRParams~%string frame_id~%string frame_value~%~%~%"))
