...
(cl:ensure-generic-function 'useRealRobot-val :lambda-list '(m))
(cl:defmethod useRealRobot-val ((m <Parameters>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulator-msg:useRealRobot-val is deprecated.  Use simulator-msg:useRealRobot instead.")
  (useRealRobot m))

(cl:ensure-generic-function 'useLidar-val :lambda-list '(m))
(cl:defmethod useLidar-val ((m <Parameters>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulator-msg:useLidar-val is deprecated.  Use simulator-msg:useLidar instead.")
  (useLidar m))

(cl:ensure-generic-function 'useSArray-val :lambda-list '(m))
(cl:defmethod useSArray-val ((m <Parameters>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulator-msg:useSArray-val is deprecated.  Use simulator-msg:useSArray instead.")
  (useSArray m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Parameters>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'useRealRobot) 1 0)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'useLidar) 1 0)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'useSArray) 1 0)) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Parameters>) istream)
  "Deserializes a message object of type '<Parameters>"
    ...
    (cl:setf (cl:slot-value msg 'useRealRobot) (cl:not (cl:zerop (cl:read-byte istream))))
    (cl:setf (cl:slot-value msg 'useLidar) (cl:not (cl:zerop (cl:read-byte istream))))
    (cl:setf (cl:slot-value msg 'useSArray) (cl:not (cl:zerop (cl:read-byte istream))))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Parameters>)))
  ...
  "b8da773b9a3eb19514cafc70e9a72680")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Parameters)))
  "Returns md5sum for a message object of type 'Parameters"
  "b8da773b9a3eb19514cafc70e9a72680")
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Parameters>))
  ...
  (cl:list 'Parameters
    ...
    (cl:cons ':useRealRobot (useRealRobot msg))
    (cl:cons ':useLidar (useLidar msg))
    (cl:cons ':useSArray (useSArray msg))
))
