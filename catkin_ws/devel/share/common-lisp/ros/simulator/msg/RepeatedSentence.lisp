...
(cl:defmethod cl:initialize-instance :after ((m <RepeatedSentence>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RepeatedSentence)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name simulator-msg:<RepeatedSentence> is deprecated: use simulator-msg:RepeatedSentence instead.")))

(cl:ensure-generic-function 'sentence-val :lambda-list '(m))
(cl:defmethod sentence-val ((m <RepeatedSentence>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulator-msg:sentence-val is deprecated.  Use simulator-msg:sentence instead.")
  (sentence m))

(cl:ensure-generic-function 'repeat_time-val :lambda-list '(m))
(cl:defmethod repeat_time-val ((m <RepeatedSentence>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulator-msg:repeat_time-val is deprecated.  Use simulator-msg:repeat_time instead.")
  (repeat_time m))
