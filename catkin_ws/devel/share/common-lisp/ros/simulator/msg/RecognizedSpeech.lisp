...
(cl:defmethod cl:initialize-instance :after ((m <RecognizedSpeech>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RecognizedSpeech)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name simulator-msg:<RecognizedSpeech> is deprecated: use simulator-msg:RecognizedSpeech instead.")))

(cl:ensure-generic-function 'hypothesis-val :lambda-list '(m))
(cl:defmethod hypothesis-val ((m <RecognizedSpeech>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulator-msg:hypothesis-val is deprecated.  Use simulator-msg:hypothesis instead.")
  (hypothesis m))

(cl:ensure-generic-function 'confidences-val :lambda-list '(m))
(cl:defmethod confidences-val ((m <RecognizedSpeech>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulator-msg:confidences-val is deprecated.  Use simulator-msg:confidences instead.")
  (confidences m))
