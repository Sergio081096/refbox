...
(cl:defmethod cl:initialize-instance :after ((m <InitKDB-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'InitKDB-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name simulator-srv:<InitKDB-request> is deprecated: use simulator-srv:InitKDB-request instead.")))

(cl:ensure-generic-function 'filePath-val :lambda-list '(m))
(cl:defmethod filePath-val ((m <InitKDB-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulator-srv:filePath-val is deprecated.  Use simulator-srv:filePath instead.")
  (filePath m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<InitKDB-request>)))
  ...
  "a472717e40f2402632296f64bb78ba8e")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'InitKDB-request)))
  "Returns md5sum for a message object of type 'InitKDB-request"
  "a472717e40f2402632296f64bb78ba8e")
...
(cl:defmethod cl:initialize-instance :after ((m <InitKDB-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'InitKDB-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name simulator-srv:<InitKDB-response> is deprecated: use simulator-srv:InitKDB-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <InitKDB-response>))
