...
(cl:defmethod cl:initialize-instance :after ((m <planning_cmd-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'planning_cmd-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name simulator-srv:<planning_cmd-request> is deprecated: use simulator-srv:planning_cmd-request instead.")))

(cl:ensure-generic-function 'params-val :lambda-list '(m))
(cl:defmethod params-val ((m <planning_cmd-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulator-srv:params-val is deprecated.  Use simulator-srv:params instead.")
  (params m))
...
(cl:defmethod cl:initialize-instance :after ((m <planning_cmd-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'planning_cmd-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name simulator-srv:<planning_cmd-response> is deprecated: use simulator-srv:planning_cmd-response instead.")))
...
(cl:defmethod args-val ((m <planning_cmd-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulator-srv:args-val is deprecated.  Use simulator-srv:args instead.")
  (args m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<planning_cmd-response>)))
  ...
  "simulator/planning_cmdResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'planning_cmd-response)))
  "Returns string type for a service object of type 'planning_cmd-response"
  "simulator/planning_cmdResponse")
