...
bool operator==(const ::simulator::simulator_parametersRequest_<ContainerAllocator1> & lhs, const ::simulator::simulator_parametersRequest_<ContainerAllocator2> & rhs)
{
