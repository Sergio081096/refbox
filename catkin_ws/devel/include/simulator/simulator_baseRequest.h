...
bool operator==(const ::simulator::simulator_baseRequest_<ContainerAllocator1> & lhs, const ::simulator::simulator_baseRequest_<ContainerAllocator2> & rhs)
{
...
struct MD5Sum< ::simulator::simulator_baseRequest_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x7bd395da961931e2ULL;
  static const uint64_t static_value2 = 0x5c2262a6a8d76149ULL;
};
