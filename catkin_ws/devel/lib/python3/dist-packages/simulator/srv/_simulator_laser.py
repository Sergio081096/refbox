...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_3fi().pack(_x.robot_x, _x.robot_y, _x.robot_theta, _x.new_simulation))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.robot_x, _x.robot_y, _x.robot_theta, _x.new_simulation,) = _get_struct_3fi().unpack(str[start:end])
      return self
