...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_512f().pack(*self.sensors))
      _x = self.stop
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.sensors = _get_struct_512f().unpack(str[start:end])
      start = end
      end += 1
...
def _get_struct_2f():
    ...
    return _struct_2f
_struct_512f = None
def _get_struct_512f():
    global _struct_512f
    if _struct_512f is None:
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_q3f().pack(_x.success, _x.robot_x, _x.robot_y, _x.theta))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.success, _x.robot_x, _x.robot_y, _x.theta,) = _get_struct_q3f().unpack(str[start:end])
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
