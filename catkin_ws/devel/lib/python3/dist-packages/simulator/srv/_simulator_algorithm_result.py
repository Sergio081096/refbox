...
"""
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_get_struct_200i().pack(*self.nodes_algorithm))
      _x = self.num_nodos
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.nodes_algorithm = _get_struct_200i().unpack(str[start:end])
      start = end
      end += 4
      (self.num_nodos,) = _get_struct_i().unpack(str[start:end])
      return self
