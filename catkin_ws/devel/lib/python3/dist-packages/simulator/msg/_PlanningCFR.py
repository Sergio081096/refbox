...
"""autogenerated by genpy from simulator/PlanningCFR.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  _slot_types = ['string','simulator/CFRParams[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          val1.frame_value = str[start:end].decode('utf-8', 'rosmsg')
        else:
